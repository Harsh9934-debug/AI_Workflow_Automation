    ...
    return (
        <div className="scale-50 relative w-full max-w-xs flex flex-col items-center" ref={sliderRef}>
            ...
            <div className="relative w-full h-5 flex items-center"> {/* Wrapper for track and thumb */}
                ...
                >
                    <div className="w-4 h-4 bg-white rounded-full shadow-lg border-2 border-blue-500 box-content"></div>
                </motion.div>
            </div>
        ...
        <div className="relative w-full bg-black text-white overflow-hidden min-h-screen">
            ...
            <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 min-h-screen flex flex-col justify-between">
                ...
                >
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:flex items-center space-x-6 ml-8">
                            <Link href="/sign-up" className="px-4 py-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-full text-sm transition-colors cursor-pointer">
                                Get Started
                            </Link>
                            <button className="px-4 py-2 text-sm hover:text-gray-300 transition-colors cursor-pointer">Home</button>
                            <button className="px-4 py-2 text-sm hover:text-gray-300 transition-colors cursor-pointer">Contacts</button>
                            <button className="px-4 py-2 text-sm hover:text-gray-300 transition-colors cursor-pointer">Help</button>
                            <button className="px-4 py-2 text-sm hover:text-gray-300 transition-colors cursor-pointer">Docs</button>
                        </div>
                    </div>
                    <div className="flex items-center space-x-4">
                        <Link href="/sign-in" className="hidden md:block px-4 py-2 text-sm hover:text-gray-300 transition-colors cursor-pointer">
                            Sign In
                        </Link>
                        <Link href="/sign-up" className="px-4 py-2 bg-gray-800/80 backdrop-blur-sm rounded-full text-sm hover:bg-gray-700/80 transition-colors cursor-pointer">
                            Sign Up
                        </Link>
                        {/* Mobile menu button */}
                        <button
                ...
                <AnimatePresence>
                    {mobileMenuOpen && (
                        <motion.div
                            ...
                            <div className="flex flex-col items-center justify-center h-full space-y-6 text-lg relative">
                                <button
                                ...
                                <Link href="/sign-up" className="px-6 py-3 bg-gray-800/50 rounded-full" onClick={() => setMobileMenuOpen(false)}>
                                    Get Started
                                </Link>
                                ...
                                <Link href="/sign-in" className="px-6 py-3" onClick={() => setMobileMenuOpen(false)}>
                                    Sign In
                                </Link>
                                <Link href="/sign-up" className="px-6 py-3 bg-gray-800/80 backdrop-blur-sm rounded-full" onClick={() => setMobileMenuOpen(false)}>
                                    Sign Up
                                </Link>
                            </div>
                        </motion.div>
                ...
                <motion.div
                    ...
                    initial="hidden"
                    animate="visible"
                    className="w-full z-20 absolute top-[30%] left-0 h-full pointer-events-none"
                >
                    <div className="relative w-full h-full max-w-7xl mx-auto">
                        <motion.div variants={itemVariants} className="pointer-events-auto">
                            <FeatureItem name="Smart Agents" value="Autonomous logic" position="left-4 sm:left-10 top-0" />
                        </motion.div>
                        <motion.div variants={itemVariants} className="pointer-events-auto">
                            <FeatureItem name="Visual Flows" value="Drag & drop builder" position="left-[10%] sm:left-1/4 top-16 sm:top-24" />
                        </motion.div>
                        <motion.div variants={itemVariants} className="pointer-events-auto">
                            <FeatureItem name="Secure" value="Enterprise grade" position="right-[10%] sm:right-1/4 top-16 sm:top-24" />
                        </motion.div>
                        <motion.div variants={itemVariants} className="pointer-events-auto">
                            <FeatureItem name="Fast Deploy" value="One-click ship" position="right-4 sm:right-10 top-0" />
                        </motion.div>
                    </div>
                </motion.div>
                ...
                <div className="flex-grow flex items-center justify-center">
                    ...
                    >
                        ...
                        <motion.h2
                            variants={itemVariants}
                            className="text-3xl md:text-5xl pb-3 font-light bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent tracking-tight"
                        >
                            Automation
                        </motion.h2>
                        ...
                        <motion.p
                            variants={itemVariants}
                            className="text-gray-400 mb-9 max-w-2xl text-lg font-light"
                        >
                            Build, deploy, and scale intelligent agents. Orchestrate complex processes with a simple, visual interface.
                        </motion.p>
                        ...
                        <Link href="/sign-up">
                            <motion.button
                                ...
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                className="mt-8 px-8 py-3 bg-white/10 backdrop-blur-md rounded-full hover:bg-white/20 transition-all border border-white/20 shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)] cursor-pointer"
                            >
                                Start Building Now
                            </motion.button>
                        </Link>
            ...
            >
                ...
                {/* Glowing circle */}
                <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-b from-blue-500/20 to-purple-600/10 blur-3xl opacity-50"></div>

                {/* Central light beam - now using the state variable for hue */}
                <div className="absolute top-0 w-[100%] left-1/2 transform -translate-x-1/2 h-full opacity-60 mix-blend-screen">
                    <Lightning
                ...
                {/* Planet/sphere */}
                <div className="z-10 absolute top-[55%] left-1/2 transform -translate-x-1/2 w-[600px] h-[600px] backdrop-blur-sm rounded-full bg-[radial-gradient(circle_at_25%_90%,_#1e386b_15%,_#000000de_70%,_#000000ed_100%)] shadow-2xl"></div>
            </motion.div>
        </div>
    );
};
